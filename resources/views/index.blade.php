                                ...
                                <div class="col-lg-4 d-flex align-items-stretch">
                                    <div class="card mb-4 box-shadow">
                                        <a href="{{ route('product.view', [$firstad->id, $firstad->slug]) }}"> <img
                                                ...
                                                src="{{ asset($category->image) }}" alt="Card image cap"></a>
                                        <div class="card-body">
                                    ...
                                    <div class="card mb-4 box-shadow">
                                        <a
                                            ...
                                            <img class="card-img-top" style="width:100%; height: 250px; background-size: cover;"
                                                src="{{ asset($firstAdsForElectronic->feature_image) }}"
                                ...
                                <div class="col-lg-4 d-flex align-items-stretch">
                                    <div class="card mb-4 box-shadow">
                                        <a
                                            ...
                                            <img class="card-img-top" style="width:100%; height: 250px; background-size: cover;"
                                                src="{{ asset($secondsAdsForElectronic->feature_image) }}"></a>
            ...
            <div class="row mt-5">
                ...
                @foreach ($advertisements as $advertisement)
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="card mb-4 box-shadow">
                            <img class="card-img-top" style="width:100%; height: 250px; background-size: cover;"
                                src="{{ asset($advertisement->feature_image) }}" alt="Card image cap">
                            <div class="card-body">
